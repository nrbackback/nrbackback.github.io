...
**GET **[http://localhost:8888/from/me](http://localhost:8888/from/me) 或者 GET [http://localhost:8888/from/you](http://localhost:8888/from/you) 即可看到效果。
...
**请求POST **[http://127.0.0.1:8888/user/login](http://127.0.0.1:8888/user/login) 获取JWT。
...
** GET **[http://127.0.0.1:8889/search/do?name=xxx](http://127.0.0.1:8889/search/do?name=xxx) 的 headers 加上 Authorization 才可以成功验证通过，否则会报 401Unauthorized。
